...
import attrs
from agentune.simulate import Conversation, Message, ParticipantRole
from agentune.simulate.models.message import MessageDraft
from agentune.simulate.participants import Participant
