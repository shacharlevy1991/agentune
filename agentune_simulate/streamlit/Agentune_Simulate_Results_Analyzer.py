"""
💬 Agentune Simulate Results Analyzer

A Streamlit app for analyzing and visualizing RAG simulation results with file upload functionality.
This is the main page of the Agentune Simulate Streamlit application.
"""
...
def main():
    ...
    st.title("💬 Agentune Simulate Results Analyzer")
    ...
    if uploaded_file is None:
        st.markdown("""
        ## Welcome to the Agentune Simulate Results Analyzer! 🎉
        ...
        - JSON files generated by the agentune simulate (e.g., `simple_simulation_results.json`)
        """)
        st.stop()
